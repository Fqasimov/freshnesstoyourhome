...
const OWN: Record<Lang, Table> = {
  az: {
    ...
    "profile.privacy": "Məxfilik siyasəti",
    ...
    "retry": "Yenidən",
    "loading": "Yüklənir…",
    "push.channel": "Sifarişlər",
    "push.askTitle": "Sifarişinizi izləyin",
    "push.askBody": "Kuryer yola çıxanda və çəki dəqiqləşəndə sizə bildiriş göndərək?",
    "push.enable": "Bəli, bildiriş göndərin",
    "push.notNow": "İndi yox",
    "push.title": "Bildirişlər",
    "push.on": "Sifariş bildirişləri açıqdır",
    "push.off": "Sifariş bildirişləri bağlıdır",
    "push.blocked": "Bildirişlər telefon ayarlarında bağlanıb. Açmaq üçün Ayarlar bölməsinə keçin.",
  },
  ru: {
    "app.name": "Freshness To Your Home",
    ...
    "loading": "Загрузка…",
    "push.channel": "Заказы",
    "push.askTitle": "Следите за заказом",
    "push.askBody": "Прислать уведомление, когда курьер выедет и когда товар взвесят?",
    "push.enable": "Да, присылайте",
    "push.notNow": "Не сейчас",
    "push.title": "Уведомления",
    "push.on": "Уведомления о заказах включены",
    "push.off": "Уведомления о заказах выключены",
    "push.blocked": "Уведомления отключены в настройках телефона. Включите их в Настройках.",
  },
  en: {
    "app.name": "Freshness To Your Home",
    ...
    "loading": "Loading…",
    "push.channel": "Orders",
    "push.askTitle": "Follow your order",
    "push.askBody": "Shall we let you know when the courier sets off, and what the final weight comes to?",
    "push.enable": "Yes, notify me",
    "push.notNow": "Not now",
    "push.title": "Notifications",
    "push.on": "Order notifications are on",
