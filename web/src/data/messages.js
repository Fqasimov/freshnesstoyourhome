...
export const I18N = {
  az: {
    ...
    'cat.h':'Kataloq','cat.lede':'Altı bölmə, əlli dörd məhsul. Axtarın və ya soldan seçin.',
    ...
    'shop.showAll':'Bütün 54 məhsulu göstər','shop.showCounters':'Bölmələrə qayıt',
  ...
  ru: {
    ...
    'cat.h':'Каталог','cat.lede':'Шесть разделов, пятьдесят четыре позиции. Найдите поиском или выберите слева.',
    ...
    'shop.showAll':'Показать все 54 товара','shop.showCounters':'Вернуться к разделам',
  ...
  en: {
    ...
    'cat.h':'Catalogue','cat.lede':'Six counters, fifty-four products. Search, or choose from the left.',
    ...
    'shop.showAll':'Show all 54 products','shop.showCounters':'Back to the counters',
