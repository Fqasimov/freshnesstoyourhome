...
export const PRODUCTS = [
  ...
  { id: 'salmon-steaks', cat: 'fresh', price: 60, unit: { en: '1 kg', az: '1 kg', ru: '1 кг', kind: 'kg', qty: 1 },
    ...
    den: 'Bone-in salmon steaks cut to order, delivered on ice. About 2–3 steaks per kilo, each 300–500 g.',
    daz: 'Sifarişlə kəsilmiş qızıl balıq steyki, buz üzərində çatdırılır. 1 kq-da təxminən 2–3 steyk olur, hər biri 300–500 qram.',
    dru: 'Стейки лосося на кости, режем под заказ, привозим на льду. В 1 кг обычно 2–3 стейка, каждый по 300–500 г.' },
  ...
  { id: 'fresh-forel', cat: 'fresh', price: 20, unit: { en: '1 kg', az: '1 kg', ru: '1 кг', kind: 'kg', qty: 1 },
    en: 'Fresh Trout', az: 'Təzə forel', ru: 'Свежая форель',
    den: 'One whole trout (weight: 2.5–3.5 kg). Cut into fillets or steaks to your preference — every part of the fish ships together.',
    daz: '1 ədəd bütöv forel balığı (çəki: 2,5–3,5 kq). İstəyinizə uyğun olaraq file və ya steyk formasında doğranır — balığın bütün hissələri birlikdə göndərilir.',
    dru: 'Целая форель (вес: 2,5–3,5 кг). Нарезаем на филе или стейки по вашему желанию — отправляем со всеми частями рыбы.' },
  ...
  { id: 'atlantic-lobster', cat: 'seafood', price: 60, unit: { en: '350 gr', az: '350 gr', ru: '350 г', kind: 'g', qty: 350 },
  ...
  { id: 'green-mussels', cat: 'seafood', price: 39, unit: { en: '800 g', az: '800 gr', ru: '800 г', kind: 'g', qty: 800 },
  ...
  { id: 'dimartino-pasta', cat: 'pantry', price: 18, unit: { en: '500 gr', az: '500 gr', ru: '500 г', kind: 'g', qty: 500 },
    ...
    den: 'Pastificio G. Di Martino Dolce & Gabbana special edition — Pasta di Gragnano IGP, bronze-die cut. Available in Fusilli, Tortiglioni, Spaghetti, Farfalle, Gnocchi Sardi and Linguine.',
    daz: 'Pastificio G. Di Martino Dolce & Gabbana xüsusi nəşr — Pasta di Gragnano IGP, bürünc kalıpda. Fusilli, Tortiglioni, Spaghetti, Farfalle, Gnocchi Sardi və Linguine növlərində.',
    dru: 'Лимитированная серия Pastificio G. Di Martino × Dolce & Gabbana — Pasta di Gragnano IGP, отлита в бронзовой матрице. Фузилли, Тортильони, Спагетти, Фарфалле, Ньокки Сарди и Лингвини.' },
]
